  ...
  return (
    <div className="text-white text-wrap">
      ...
      <p>
        ...
        services offered by Monica (“company”). by visiting the website and/or
        mobile app or using the services in any manner, you agree that you have
        read, understood and agree and accept to be bound by and a party to the
        terms and conditions of this agreement to the exclusion of all other
        terms. If the terms of this agreement are considered an offer,
        acceptance is expressly limited to such terms. If you do not
        unconditionally agree to all the terms and conditions of this agreement,
        you have no right to use the apps or services. use of company’s services
        is expressly conditioned upon your assent to all the terms and
        conditions of this agreement, to the exclusion of all other terms. if
        you do not agree to these terms of service, please do not use this
        website or the app.
      </p>
      <p>
        Country refers to: Bangladesh <br />
        Company (referred to as either &quot;the Company&quot;, &quot;We&quot;,
        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Monica.
      </p>
      <h4>Who can use</h4>
      <p>
        ...
        contact us at. You represent and warrant to Company that: (i) you are of
        legal age and you can form a binding contract with us and you are not
        prohibited by law from accessing or using the services; (ii) all
        registration information you submit is accurate and truthful; and (iii)
        you will maintain the accuracy of such information. You also certify
        that you are legally permitted to use and access the Services and take
      ...
      <p>
        ...
        warrant that: (i) You have the legal right to use any credit or debit
        card(s) or other payment method(s) in connection with any Order; and
        that (ii) the information You supply to us is true, correct and
        complete. By submitting such information, You grant us the right to
        provide the information to payment processing third parties for purposes
      ...
      <p>
        ...
        websites. We cannot and do not guarantee the accuracy or completeness of
      ...
      <h4>Payments</h4>
      <p>
        Payment can be made through a valid card (credit cards or debit cards)
        and are subject to validation checks and authorization by Your card
        issuer. If we do not receive the required authorization, We will not be
      ...
      <ul>
        ...
        <p>
          ...
          periodic basis either monthly or yearly. depending on the type of
          Subscription plan you select when purchasing the Subscription. At the
          end of each period, Your Subscription will automatically renew under
          the exact same conditions unless You cancel it or the Company cancels
          it.
        </p>
      </ul>
    </div>
