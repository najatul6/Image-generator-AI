...
const LogIn = () => {
  return (
    <div className="bg-dark-blue min-h-screen mx-auto flex justify-center items-center">
      <div className="w-3/5 flex justify-center items-center bg-low-blue mx-auto py-10 px-5 rounded-xl shadow-lg shadow-slate-400">
        <div className="w-full">
          <h2 className="flex justify-center items-center text-2xl font-bold py-3 uppercase text-white">
            Log In
          </h2>
